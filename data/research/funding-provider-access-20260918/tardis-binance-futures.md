> For the complete documentation index, see [llms.txt](https://docs.tardis.dev/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.tardis.dev/historical-data-details/binance-futures.md).
...
```
GET https://docs.tardis.dev/historical-data-details/binance-futures.md?ask=<question>&goal=<endgoal>
```
